# MindMaster Grade 1 – Unit Specifications & Learning Outcomes
...
## Table of Contents
- [Unit 1: What is Psychology?](#unit-1-table)
- [Unit 2: Exploring Our Senses (Sight, Sound, Touch)](#unit-2-table)
- [Unit 3: Basics of Attention and Focus](#unit-3-table)
- [Unit 4: How Memory Works](#unit-4-table)
- [Unit 5: Imagination and Storytelling](#unit-5-table)
- [Unit 6: What are Feelings?](#unit-6-table)
- [Unit 7: Family and Friendship Dynamics](#unit-7-table)
- [Unit 8: Problem-Solving Basics](#unit-8-table)
- [Unit 9: Our Actions and Impact](#unit-9-table)
- [Unit 10: Teamwork and Cooperation](#unit-10-table)
...
<p>The lesson normalizes that choosing helpful actions isn't always easy when frustrated or tired, but that the thinking-before-acting pattern strengthens with practice. This builds self-efficacy through genuine control over outcomes rather than mere compliance, supporting executive function development through scaffolded practice.</p></td>
<td><p><strong>By the end of Lesson 3, students will be able to:</strong></p>
<ol type="1">
